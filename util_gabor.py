...
############# BW_image_jax/jit version - under development ##############
...
def BW_image_jax(BW_image_const_inp,x,y,alpha_channel,mask, background, roi, ref_ori, jitter, seed):
    ...
    #x = BW_image_const_inp[5]
    #y = BW_image_const_inp[6]
    #alpha_channel = BW_image_const_inp[7]
    #mask = BW_image_const_inp[8]
    #background = BW_image_const_inp[9]
    #roi = BW_image_const_inp[10]
