...
class SsnLayerPars:
    ...
    def __init__(self, conn_pars_m, conn_pars_s, ssn_pars):
        self.J_2x2_s, self.s_2x2_s, self.gE_s, self.gI_s, self.conn_pars_s = ssn_init_param(1, conn_pars_s, ssn_pars)
        self.J_2x2_m, _, self.gE_m, self.gI_m, self.conn_pars_m = ssn_init_param("C", conn_pars_m, ssn_pars, middle=True)
        self.gE = [self.gE_m, self.gE_s]
        self.gI = [self.gI_m, self.gI_s]
ssn_layer_pars = SsnLayerPars(conn_pars_m, conn_pars_s, ssn_pars)
