...
def corr_from_csvs(folder,num_trainings, batch_size = 100):
    ...
    J_m_diff = numpy.zeros((num_trainings,6))
    J_s_diff = numpy.zeros((num_trainings,6))
    ...
    for i in range(num_trainings):
        ...
        relative_changes, time_inds = calculate_relative_change(df)
        ...
        J_m_diff[i,4] = (J_m_EE[training_end]+J_m_IE[training_end]) - (J_m_EE[training_start]+J_m_IE[training_start]) / (J_m_EE[training_start]+J_m_IE[training_start])
        J_m_diff[i,5] = (J_m_II[training_end]+J_m_EI[training_end]) - (J_m_II[training_start]+J_m_EI[training_start]) / (J_m_II[training_start]+J_m_EI[training_start])
        J_s_diff[i,4] = (J_s_EE[training_end]+J_s_IE[training_end]) - (J_s_EE[training_start]+J_s_IE[training_start]) / (J_s_EE[training_start]+J_s_IE[training_start])        
        J_s_diff[i,5] = (J_s_II[training_end]+J_s_EI[training_end]) - (J_s_II[training_start]+J_s_EI[training_start]) / (J_s_II[training_start]+J_s_EI[training_start])
        J_m_diff[i,0:4]= relative_changes[0:4,1] *100
        J_s_diff[i,0:4]= relative_changes[4:8,1] *100
