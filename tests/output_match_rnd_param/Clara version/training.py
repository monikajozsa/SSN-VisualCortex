...
def training_loss(ssn_layer_pars, readout_pars, constant_pars, train_data, noise_ref, noise_target):
    ...
    total_loss, all_losses, pred_label, sig_input, x, max_rates = vmap_ori_discrimination(ssn_layer_pars, readout_pars, constant_pars, train_data, noise_ref, noise_target)
