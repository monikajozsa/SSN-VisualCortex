...
list_of_fig_names = [
    ['offset_pre_post','boxplot_relative_changes'], 
...
list_of_titles = [
    ['Discrimination thresholds before and after training', 'Relative and absolute changes in model parameters before and after training'], 
...
scaling_vector = [ [0.7, 1], [1,1,1,1], [1], [1,0.8,0.5,0.5], [0.8,0.9,0.9], [1]]
